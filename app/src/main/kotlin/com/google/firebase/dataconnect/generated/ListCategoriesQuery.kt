    ...
    >
{
  ...
  public companion object {
    public val operationName: String = "ListCategories"
...
public fun ListCategoriesQuery.ref(
  
    
  
    block_: ListCategoriesQuery.Variables.Builder.() -> Unit = {}
  ...
  ref(
      ...
      ListCategoriesQuery.Variables.build(
...
public suspend fun ListCategoriesQuery.execute(
  ...
  public fun ListCategoriesQuery.flow(
    
      
  
    block_: ListCategoriesQuery.Variables.Builder.() -> Unit = {}
    
    ): kotlinx.coroutines.flow.Flow<ListCategoriesQuery.Data> =
    ref(
