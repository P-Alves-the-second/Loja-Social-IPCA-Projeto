...
public interface ListActiveStatusTypesQuery :
    ...
    >
{
  ...
  public companion object {
    public val operationName: String = "ListActiveStatusTypes"
...
public fun ListActiveStatusTypesQuery.ref(
  
    
  
    block_: ListActiveStatusTypesQuery.Variables.Builder.() -> Unit = {}
  ...
  ref(
      ...
      ListActiveStatusTypesQuery.Variables.build(
...
public suspend fun ListActiveStatusTypesQuery.execute(
  ...
  public fun ListActiveStatusTypesQuery.flow(
    
      
  
    block_: ListActiveStatusTypesQuery.Variables.Builder.() -> Unit = {}
    
    ): kotlinx.coroutines.flow.Flow<ListActiveStatusTypesQuery.Data> =
    ref(
