...
public interface ListStatusTypesQuery :
    ...
    >
{
  ...
  public companion object {
    public val operationName: String = "ListStatusTypes"
...
public fun ListStatusTypesQuery.ref(
  
    
  
    block_: ListStatusTypesQuery.Variables.Builder.() -> Unit = {}
  ...
  ref(
      ...
      ListStatusTypesQuery.Variables.build(
...
public suspend fun ListStatusTypesQuery.execute(
  ...
  public fun ListStatusTypesQuery.flow(
    
      
  
    block_: ListStatusTypesQuery.Variables.Builder.() -> Unit = {}
    
    ): kotlinx.coroutines.flow.Flow<ListStatusTypesQuery.Data> =
    ref(
