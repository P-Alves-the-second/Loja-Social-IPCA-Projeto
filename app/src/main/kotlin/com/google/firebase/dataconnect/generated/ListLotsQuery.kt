...
public interface ListLotsQuery :
    ...
    >
{
  ...
  public companion object {
    public val operationName: String = "ListLots"
...
public fun ListLotsQuery.ref(
  
    
  
    block_: ListLotsQuery.Variables.Builder.() -> Unit = {}
...
public suspend fun ListLotsQuery.execute(
  ...
  public fun ListLotsQuery.flow(
    
      
  
    block_: ListLotsQuery.Variables.Builder.() -> Unit = {}
    
    ): kotlinx.coroutines.flow.Flow<ListLotsQuery.Data> =
    ref(
